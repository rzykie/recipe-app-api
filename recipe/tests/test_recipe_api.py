...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email="user@example.com", password="123")
    ...
    def test_partial_update(self):
        """Test partial upate of a recipe"""
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            "time_minutes": 25,
            "price": Decimal("4.25"),
            "ingredients": [{"name": "Lemon"}, {"name": "Honey Garlic"}],
        }
    ...
    def test_create_ingredient_on_update(self):
        ...
        payload = {"ingredients": [{"name": "Parsley"}]}
        url = detail_url(recipe.id)
        res = self.client.patch(url, payload, format="json")

        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(user=self.user, name="Parsley")
    ...
    def test_clear_ingredient_tags(self):
    ...
    def test_filter_by_ingredients(self):
        ...
        recipe2 = create_recipe(user=self.user, title="Chicken Rossiterie")
